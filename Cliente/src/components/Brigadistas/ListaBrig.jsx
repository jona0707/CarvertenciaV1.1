...
export const ListaBrig = () => {
    ...
    useEffect(() => {
        ...
        axios.get("http://localhost:8000/api/carvertencia/comu/65e4f933e2c96cbb8993870e", {
            headers: {
            ...
            .then((brigs) => {
                ...
                Promise.all(requests)
                    .then(responses => {
                        ...
                        const avatar = responses.map(response => response.data.avatarBrig);
