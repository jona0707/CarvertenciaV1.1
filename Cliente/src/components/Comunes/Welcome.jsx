...
export const Welcome = () => {
    ...
    const handleBrigs = () => nav("/"+nombre+"/brigadistas")
    const handleOwns =  () => nav("/"+nombre+"/propietarios")
    const handleCars =  () => nav("/"+nombre+"/autos")
    ...
    return (
        <>
            <Banner ruta={"/comunidades"} nombreAdmin={userAdmin} />
            ...
            <Container maxWidth={false} sx={{ // con maxWidth = false hacemos que no haya un ancho maximo, sino que ocupe toda la página
                ...
                <Typography sx={{ mt: 2 }} variant="h2" fontWeight={"bold"} textAlign={"center"}> {nombre}</Typography>
