    ...
    return (
        ...
        <Banner ruta="/comunidades"/>
            ...
            <Container maxWidth={false} sx={{   // con sx podemos manejar varios estilos de CSS de manera más simple 
                ...
                <Typography variant="h3" fontWeight={"bold"} textAlign={'center'} marginTop={5}> CREA UNA COMUNIDAD</Typography>
                ...
                <CustomBtn texto={"CREAR"} style={{ marginBottom: "10rem" }} ruta={"/comunidades"}/>
